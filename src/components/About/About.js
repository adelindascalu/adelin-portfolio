      ...
      <div className='container about'>
        <div className='about-text-box'>
          ...
          <p className='about-description'>
            ...
            when I joined a Web Development training program and realized it was
            a perfect fit. My goal is to improve my skills, with the main focus
            on designing and building websites that offer a smooth user
            experience.
          </p>
